...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 04 - Emily Calderon Monroy", nullptr, nullptr);
...
//rojection = glm::ortho(0.0f, (GLfloat)screenWidth, 0.0f, (GLfloat)screenHeight,-0.1f, 1000.0f);//Izq,Der,Fondo,Alto,Cercania,Lejania
	while (!glfwWindowShouldClose(window))
	{
	    ...
	    //Figura central
	    view = glm::translate(view, glm::vec3(-2.0f, -8.0f, -39.0f));
		model = glm::rotate( model, glm::radians(45.0f), glm::vec3( 0.0f, 5.0f, -20.0f));
		model = glm::rotate(model, glm::radians(15.0f), glm::vec3(0.0f, 4.0f, 1.0f));// use to compare orthographic and perspective projection
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		//Figura base inferior derecha
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(4.0f, 1.5f, -10.0f));
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 0.0f, 1.0f)); // use to compare orthographic and perspective projection
		model = glm::rotate(model, glm::radians(35.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(25.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(4.0f, 4.0f, 4.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		//Figura base inferior izquierda
		model = glm::mat4(1);
		...
		model = glm::rotate(model, glm::radians(-15.0f), glm::vec3(0.0f, 1.0f, 0.0f));// use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(4.0f, 4.0f, 4.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
